export const widgetBrowserScript = `(() => {
  ...
  function css() {
    ...
    return "<style>" +
      ":host{all:initial;--ak-color:" + color + ";font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,Segoe UI,sans-serif;color:#0f172a}" +
      ...
      ".ak-greeting{max-width:260px;border:1px solid rgba(15,23,42,.1);border-radius:14px;background:#fff;padding:10px 12px;box-shadow:0 20px 60px rgba(15,23,42,.16);font-size:14px;line-height:1.45;color:#23304b}" +
      ".ak-launcher{width:64px;height:64px;border:0;border-radius:999px;background:var(--ak-color);box-shadow:0 18px 50px rgba(53,92,255,.32);color:#fff;display:grid;place-items:center;cursor:pointer;font:700 18px inherit}" +
      ".ak-panel{width:min(380px,calc(100vw - 28px));height:min(620px,calc(100vh - 34px));border:1px solid rgba(15,23,42,.12);border-radius:18px;background:#fff;box-shadow:0 26px 90px rgba(15,23,42,.22);overflow:hidden;display:grid;grid-template-rows:auto 1fr auto}" +
      ...
      ".ak-identity{display:flex;align-items:center;gap:10px;min-width:0}.ak-avatar{width:42px;height:42px;border-radius:999px;background:var(--ak-color);color:#fff;display:grid;place-items:center;font-weight:800;flex:0 0 auto}.ak-title{min-width:0}.ak-title strong{display:block;font-size:15px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.ak-title span{display:block;margin-top:2px;color:#667085;font-size:12px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}" +
      ".ak-close{border:1px solid rgba(15,23,42,.12);border-radius:999px;background:#fff;color:#0f172a;width:34px;height:34px;cursor:pointer;font:700 18px inherit}" +
      ...
      ".ak-message{max-width:88%;border:1px solid rgba(15,23,42,.08);border-radius:14px;padding:10px 12px;background:#fff;color:#1f2937;font-size:14px;line-height:1.45;white-space:pre-wrap}.ak-message.ak-visitor{justify-self:end;background:#eef3ff}.ak-message.ak-avatar{justify-self:start;background:#fff}.ak-media{margin-top:8px;display:grid;gap:6px}.ak-media audio,.ak-media video{width:100%;max-width:260px;border-radius:10px}.ak-media video{background:#0f172a;aspect-ratio:16/9}" +
      ".ak-lead-card{border:1px solid rgba(53,92,255,.2);border-radius:14px;background:#fff;padding:12px;display:grid;gap:10px;color:#23304b}.ak-lead-card h3{margin:0;font:800 14px inherit;color:#0f172a}.ak-lead-card p{margin:0;color:#667085;font-size:13px;line-height:1.45}.ak-lead-grid{display:grid;gap:8px}.ak-lead-field{display:grid;gap:5px;font:700 12px inherit;color:#344054}.ak-lead-field input,.ak-lead-field textarea{width:100%;border:1px solid rgba(15,23,42,.14);border-radius:10px;padding:9px 10px;font:13px inherit;outline:none}.ak-lead-field textarea{min-height:74px;resize:vertical}.ak-lead-actions{display:flex;flex-wrap:wrap;gap:8px}.ak-lead-submit,.ak-lead-skip{min-height:38px;border-radius:10px;padding:0 12px;font:800 13px inherit;cursor:pointer}.ak-lead-submit{border:0;background:var(--ak-color);color:#fff}.ak-lead-skip{border:1px solid rgba(15,23,42,.12);background:#fff;color:#344054}.ak-lead-submit:disabled{opacity:.58;cursor:not-allowed}.ak-lead-error{border:1px solid #fecaca;border-radius:10px;background:#fef2f2;color:#991b1b;padding:8px 10px;font-size:13px}.ak-lead-success{border:1px solid #a7f3d0;border-radius:10px;background:#ecfdf3;color:#0f5f2d;padding:10px;font-size:13px;font-weight:700}" +
      ".ak-thinking{justify-self:start;border-radius:999px;background:#fff;border:1px solid rgba(15,23,42,.08);padding:8px 11px;color:#667085;font-size:13px}" +
      ".ak-form{display:grid;grid-template-columns:1fr auto;gap:8px;padding:12px;border-top:1px solid rgba(15,23,42,.08);background:#fff}.ak-input{min-height:42px;border:1px solid rgba(15,23,42,.14);border-radius:12px;padding:0 12px;font:14px inherit;outline:none}.ak-input:focus{border-color:var(--ak-color);box-shadow:0 0 0 3px rgba(53,92,255,.14)}.ak-send{min-height:42px;border:0;border-radius:12px;background:var(--ak-color);color:#fff;padding:0 14px;font:700 14px inherit;cursor:pointer}.ak-send:disabled{opacity:.58;cursor:not-allowed}" +
