export const widgetBrowserScript = `(() => {
  ...
  function css() {
    ...
    return "<style>" +
      ...
      ".ak-panel{width:min(380px,calc(100vw - 28px));height:min(620px,calc(100vh - 34px));border:1px solid rgba(15,23,42,.12);border-radius:18px;background:#fff;box-shadow:0 26px 90px rgba(15,23,42,.22);overflow:hidden;display:grid;grid-template-rows:auto 1fr auto;animation:akWidgetPanelIn .28s var(--ak-ease-emphasis) both}" +
